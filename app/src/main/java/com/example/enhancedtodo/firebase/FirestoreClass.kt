package com.example.enhancedtodo.firebase
...
import com.example.enhancedtodo.activities.*
    ...
    fun addUpdateTaskList(activity: Activity, board: Board) {
        ...
        mFireStore.collection(Constants.BOARDS)
            ...
            .addOnSuccessListener {
                ...
                Log.e(activity.javaClass.simpleName, "Error on Task List Update", e)
            }
    ...
    fun assignedMemberToBoard(activity: MembersActivity, board: Board, user: User) {
        ...
        mFireStore.collection(Constants.BOARDS)
            ...
            .addOnSuccessListener {
                ...
                Log.e(
                    activity.javaClass.simpleName,
                    "Error while assigning member to board",
                    e
                )
            }
