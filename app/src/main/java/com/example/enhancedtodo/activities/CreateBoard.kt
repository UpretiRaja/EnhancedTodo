...
import com.example.enhancedtodo.databinding.ActivityCreateBoardBinding
...
class CreateBoard : BaseActivity() {
    ...
    private fun setUpActionBar() {
        val toolbarCreateBoard =
            findViewById<androidx.appcompat.widget.Toolbar>(R.id.toolbar_create_board_activity)
